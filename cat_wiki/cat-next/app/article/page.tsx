export default function Page() {
    return (
        <article className="max-w-3xl mx-auto p-6">
            ...
            <p className="mb-4">
                Cats may have an independent nature, but they also form strong
                bonds with their human companions. Their playful antics and
                affectionate moments provide companionship that can alleviate
            ...
            <p className="mb-4">
                Contrary to popular belief, having a cat in the house may
                actually help reduce the risk of allergies in children. Exposure
                to cat dander from a young age can build immunity and decrease
            ...
            <p className="mb-4">
                Caring for a cat instills a sense of responsibility and routine.
                Feeding, grooming, and providing medical care for your feline
                friend create a structured daily routine, which can be
                especially beneficial for individuals who thrive on consistency.
            </p>
